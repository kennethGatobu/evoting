					...
					if(isset($_SESSION['logged_user']))
					{
						...
						if (odbc_num_rows($qry)>0) {
							...
							echo '<div class="col-md-6">
								  ...
								  <div class="form-group" >
									...
									<h3 class="panel-title">APIs Documentation</h3>
									   ...
									   <h4>API Key (Token)</h4>
										...
										<p>Example: https://evoting.kcau.ac.ke/data.php</p>
										<H4>API Call</h3>
										<p>The endpoint takes the following parameters:</p>
										   <P><strong>Method:</strong></p> POST<P>
										   <p><strong>Post Parameters: </strong>
										    {reg_no,student_name,gender,email,course_code,campus_code,username,_token,_election_period}  
										   </p>
										   ...
										   <table class="table table-bordered table-striped">
												...
												<tr>
												   <td>_election_period</td>
												   <td>- is election Period</td>
												</tr>
								...
								var client = new RestClient("https://evoting.kcau.ac.ke/data.php"); <br>
									client.Timeout = -1; <br>
									var request = new RestRequest(Method.POST); <br>
									request.AddHeader("_token", "232121"); <br>
									request.AlwaysMultipartFormData = true; <br>
									request.AddParameter("reg_no", "22/01529"); <br>
									request.AddParameter("student_name", "Kenneth Gatobu"); <br>
									request.AddParameter("gender", "Male"); <br>
									request.AddParameter("email", "2201529@students.kcau.ac.ke"); <br>
									request.AddParameter("course_code", "KCABSD"); <br>
									request.AddParameter("campus_code", "MAIN"); <br>
									request.AddParameter("username", "ken"); <br>
									...
									Console.WriteLine(response.Content); </div>'; 
									  ...
									  <img src="images/sampleDataImage.png" class="image-responsive" style="width:100%">
